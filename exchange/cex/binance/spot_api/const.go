...
const (
	REQUEST_WEIGHT WeightType = "REQUEST_WEIGHT"
	ORDERS         WeightType = "ORDERS"
	RAW_REQUESTS   WeightType = "RAW_REQUESTS"
)
...
const (
	MOVE_ACCOUNT_TYPE_INVALID         MoveAccountType = ""
	MOVE_ACCOUNT_TYPE_SPOT            MoveAccountType = "SPOT"
	MOVE_ACCOUNT_TYPE_FUTURE          MoveAccountType = "USDT_FUTURE"
	MOVE_ACCOUNT_TYPE_C_FUTURE        MoveAccountType = "COIN_FUTURE"
	MOVE_ACCOUNT_TYPE_MARGIN          MoveAccountType = "MARGIN"
	MOVE_ACCOUNT_TYPE_ISOLATED_MARGIN MoveAccountType = "ISOLATED_MARGIN"
)
...
const (
	...
	MOVE_STATUS_SUCCESS   MoveStatus = "SUCCESS"
