...
func NewUApiClient(conf base.APIConf, maps ...interface{}) *UApiClient {
	...
	spot_api.GlobalUBaseOnce.Do(func() {
		if spot_api.BinanceUBaseWeight == nil {
			spot_api.BinanceUBaseWeight = base.NewRateLimitMgr()
		}
	})
	a.WeightMgr = spot_api.BinanceUBaseWeight
...
func NewUApiClient2(conf base.APIConf, cli *http.Client, maps ...interface{}) *UApiClient {
	var (
		weightInfoMap map[string]int64
		a             = &UApiClient{}
	)
...
func (a *UApiClient) PremiumIndex(options *url.Values) (*RespPremiumIndexList, error) {
	/*
	...
	*/
	...
	if options == nil || options.Get("symbol") == "" {
		...
		resp := &RespPremiumIndexItem{}
		err = a.DoRequest(a.ReqUrl.PREMIUMINDEX_URL, "GET", params, resp)
		res = &RespPremiumIndexList{resp}
	}
	return res, err
}

func (a *UApiClient) PositionSideDual(dualSidePosition string) (*spot_api.RespError, error) {
	/*
		更改持仓模式(TRADE)
...
func (a *UApiClient) GetPositionSideDual() (*RespPositionSideDual, error) {
	/*
		更改持仓模式(TRADE)
		变换用户在 所有symbol 合约上的持仓模式：双向持仓或单向持仓。
		dualSidePosition	STRING	YES	"true": 双向持仓模式；"false": 单向持仓模式
...
func (a *UApiClient) Order(symbol string, side spot_api.SideType, type_ spot_api.OrderType, options *url.Values) (*RespUBaseOrderResult, error) {
	...
	*/
	...
	var res = &RespUBaseOrderResult{}
	err = a.DoRequest(a.ReqUrl.ORDER_URL, "POST", params, res)
	return res, err
}

func (a *UApiClient) BatchOrder(batchOrders string) ([]*RespUBaseOrderResult, error) {
	/*
...
func (a *UApiClient) GetOrder(symbol string, options *url.Values) (*RespUBaseOrderResult, error) {
	/*
		查询订单状态
...
func (a *UApiClient) GetOpenOrder(symbol string, options *url.Values) (*RespUBaseOrderResult, error) {
	/*
		查询当前挂单
		symbol	STRING	YES	交易对
		orderId	LONG	NO	系统订单号
	...
	*/
	...
	res := &RespUBaseOrderResult{}
	err = a.DoRequest(a.ReqUrl.OPENORDER_URL, "GET", params, res)
	return res, err
}

func (a *UApiClient) GetOpenOrders(options *url.Values) ([]*RespUBaseOrderResult, error) {
	/*
		查看当前全部挂单
...
func (a *UApiClient) CancelOrder(symbol string, options *url.Values) (*RespUBaseOrderResult, error) {
	/*
		撤销订单 (TRADE)
		symbol	STRING	YES	交易对
		orderId	LONG	NO	系统订单号
...
func (a *UApiClient) CancelAllOpenOrders(symbol string, options *url.Values) (*spot_api.RespError, error) {
	/*
		撤销全部订单
		symbol	STRING	YES	交易对
	*/
...
func (a *UApiClient) CancelBatchOrders(symbol string, options *url.Values) ([]*RespUBaseOrderResult, error) {
	/*
		批量撤销订单
		symbol	STRING	YES	交易对
...
func (a *UApiClient) Balance() (*RespBalance, error) {
	/*
		账户余额
	*/
	params := url.Values{}
...
func (a *UApiClient) Account() (*RespAccount, error) {
	/*
		账户信息
...
func (a *UApiClient) Leverage(symbol string, leverage int64) (*spot_api.RespError, error) {
	/*
...
func (a *UApiClient) MarginType(symbol, marginType string) (*spot_api.RespError, error) {
	/*
...
func (a *UApiClient) PositionMargin(symbol string, amount float64, type_ int64) (*spot_api.RespError, error) {
	/*
...
func (a *UApiClient) CommissionRate(symbol string) (*RespCommissionRate, error) {
	/*
		针对逐仓模式下的仓位，调整其逐仓保证金资金。
		symbol	STRING	YES	交易对
		positionSide	ENUM	NO	持仓方向，单向持仓模式下非必填，默认且仅可填BOTH;在双向持仓模式下必填,且仅可选择 LONG 或 SHORT
	...
	*/
	...
	var res = &RespCommissionRate{}
	err = a.DoRequest(a.ReqUrl.COMMISSIONRATE_URL, "GET", params, res)
	return res, err
}

func (a *UApiClient) UserDataStream() (*spot_api.RespUserDataStream, error) {
	/*
...
func (a *UApiClient) PutUserDataStream(listenKey string) (interface{}, error) {
	/*
...
func (a *UApiClient) DELETEUserDataStream(listenKey string) (interface{}, error) {
	/*
		listenKey	STRING	YES
		关闭用户数据流。
	*/
